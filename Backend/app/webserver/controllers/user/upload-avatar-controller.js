...
const AVATAR_FOLDER_PATH = path.join(
  PROJECT_MAIN_FOLDER_PATH,
  "public",
  "upload",
  "avatar"
);
const AVATAR_VALID_FORMATS = ["jpeg", "png", "jpg"];
...
async function uploadAvatar(req, res) {
  ...
  try {
    ...
    // const imageUrl = `${process.env.HTTP_SERVER_DOMAIN}/upload/avatar/${userId}/avatar.jpg`;
    res.header(
      "Location",
      `${process.env.HTTP_SERVER_DOMAIN}/upload/avatar/${userId}/avatar.jpg`
    );
